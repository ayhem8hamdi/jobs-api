...
const {addJobValidation,updateJobValidator,validateJobsQuery}= require("../middlewares/job-validation-middleware");



router.route("/").get(authMiddleware,validateJobsQuery,getAllJobs).post(authMiddleware,addJobValidation,createNewJob)
